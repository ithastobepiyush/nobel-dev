...
function TimedCard({ data }: TimedCardProps) {
  ...
  return (
    ...
    <section ref={containerRef} className="relative w-full h-screen bg-[#1a1a1a] text-white overflow-hidden font-sans"
    >
